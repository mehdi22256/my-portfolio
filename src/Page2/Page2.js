...
const Page2 = ({ darkMode }) => {
  return (
    <div id="about" className={`${darkMode && "dark"} mx-auto font-nunito`}>
      <div className=" bg-primary2 dark:bg-darkPrimary2 h-auto md:h-auto pb-20 md:pb-52 pt-10">
        ...
        <div className=" flex flex-row-reverse justify-center items-center content-center flex-wrap space-14 gap-10 mt-24">
          <div className="w-80 md:w-96 2xl:w-1/3 h-auto pb-5 border-2 border-fontPrimary bg-fontDarkPrimary rounded-3xl dark:bg-darkPrimary2 dark:border-fontDarkPrimary 2xl:relative 2xl:bottom-64 2xl:right-40">
          ...
          <div className="w-80 md:w-96 h-auto border-2 border-fontPrimary bg-fontDarkPrimary rounded-3xl dark:bg-darkPrimary2 dark:border-fontDarkPrimary 2xl:relative 2xl:top-36 2xl:left-48">
            <div className="flex flex-row border-b-2 pb-2 border-fontPrimary dark:border-fontDarkPrimary">
              <div className="w-5 h-5 rounded-full bg-fontPrimary m-1 mt-4 ml-3 dark:bg-fontDarkPrimary"></div>
              <div className="w-5 h-5 rounded-full bg-fontPrimary m-1 mt-4 dark:bg-fontDarkPrimary"></div>
              <div className="w-5 h-5 rounded-full bg-fontPrimary m-1 mt-4 dark:bg-fontDarkPrimary"></div>
            ...
            <div className="flex justify-center flex-wrap gap-10 content-center p-5">
              ...
              />
              <img
                className="w-14 h-14 md:w-20 dark:brightness-200"
                src={bootStrapLogo}
                alt="bootstrap"
              />
              <img
          ...
          <div className="w-80 md:w-96 2xl:w-1/3 h-auto pb-5 border-2 border-fontPrimary bg-fontDarkPrimary rounded-3xl md:mb-auto 2xl:relative 2xl:left-10 dark:bg-darkPrimary2 dark:border-fontDarkPrimary ">
            <div className="flex flex-row border-b-2 pb-2 border-fontPrimary dark:border-fontDarkPrimary">
              <div className="w-5 h-5 rounded-full bg-fontPrimary m-1 mt-4 ml-3 dark:bg-fontDarkPrimary"></div>
              <div className="w-5 h-5 rounded-full bg-fontPrimary m-1 mt-4 dark:bg-fontDarkPrimary"></div>
              <div className="w-5 h-5 rounded-full bg-fontPrimary m-1 mt-4 dark:bg-fontDarkPrimary"></div>
